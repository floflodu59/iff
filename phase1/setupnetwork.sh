...
echo "   addresses: [192.168.51.100/24]" >> /etc/netplan/00-installer-config.yaml
echo "   gateway4: 192.168.51.254" >> /etc/netplan/00-installer-config.yaml
...
echo "    - 192.168.51.254" >> /etc/netplan/00-installer-config.yaml
